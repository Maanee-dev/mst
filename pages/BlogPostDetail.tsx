...
const BlogPostDetail: React.FC = () => {
  ...
  if (!post) return (
    <div className="p-40 text-center bg-[#FCFAF7] dark:bg-slate-950 min-h-screen">
      <h1 className="text-4xl font-serif italic mb-8 dark:text-slate-100">Dispatch missing.</h1>
    ...
    <article className="bg-white dark:bg-slate-950 min-h-screen selection:bg-sky-100 dark:selection:bg-sky-900/30">
      ...
      <div className="max-w-4xl mx-auto px-6 py-32 md:py-48">
        <div className="flex items-center gap-8 mb-20 pb-12 border-b border-slate-50 dark:border-slate-900">
           <div className="w-16 h-16 rounded-full bg-slate-100 dark:bg-slate-900 flex items-center justify-center text-xl font-serif italic font-bold text-slate-800 dark:text-slate-200">
              {post.author.charAt(0)}
           </div>
           <div>
              <p className="text-slate-900 dark:text-slate-100 font-bold uppercase tracking-widest text-[10px] mb-1">Curated by</p>
              <p className="text-slate-400 dark:text-slate-500 font-serif italic text-lg">{post.author}</p>
           </div>
        </div>

        <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
           <p className="text-2xl md:text-4xl font-serif text-slate-800 dark:text-slate-200 italic leading-[1.5] mb-20 border-l-4 border-amber-400 pl-10">
             {post.excerpt}
           </p>
           ...
           <div className="text-slate-600 dark:text-slate-400 leading-[2.2] text-lg md:text-xl font-medium space-y-12">
             ...
             <div className="bg-[#FCFAF7] dark:bg-slate-900/50 p-12 md:p-20 rounded-[3rem] border border-slate-50 dark:border-slate-800 my-24 text-center">
                ...
                <h4 className="text-3xl md:text-5xl font-serif font-bold text-slate-900 dark:text-slate-100 mb-8 italic">Experience the Perspective</h4>
