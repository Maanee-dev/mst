...
export const RESORTS: Accommodation[] = [
  ...
  },
  {
    ...
    priceRange: '$$$$$',
    rating: 5,
    shortDescription: 'A sanctuary of conscious living in the Fari Islands.',
    description: 'Patina Maldives, Fari Islands is the inaugural flagship property from Patina Hotels & Resorts. A sanctuary of conscious living, the resort offers 90 contemporary one- to three-bedroom beach and water pool villas, alongside 20 Fari Studios.',
    images: [
      'https://images.unsplash.com/photo-1540206351-d6465b3ac5c1?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1514282401047-d79a71a590e8?auto=format&fit=crop&q=80&w=1200'
    ],
    features: ['Fari Islands', 'Conscious Living', 'Contemporary Design', 'Art Installations'],
    transfers: [TransferType.SPEEDBOAT],
    mealPlans: [MealPlan.BED_BREAKFAST, MealPlan.HALF_BOARD],
    uvp: 'A sanctuary of conscious living.'
  },
  {
    id: 'res-one-only',
    name: 'One&Only Reethi Rah',
    slug: 'one-only-reethi-rah',
    type: AccommodationType.RESORT,
    atoll: 'North Male Atoll',
    priceRange: '$$$$$',
    rating: 5,
    shortDescription: 'An ultra-luxury all-villa resort set on one of the largest islands.',
    description: 'One&Only Reethi Rah is an ultra-luxury all-villa resort offering an unrivalled level of style, choice and personalised exploration. Set on one of the largest islands in North Male Atoll, it features 12 pristine beaches and turquoise lagoons.',
    images: [
      'https://images.unsplash.com/photo-1467377229449-49366afbb762?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1473116763249-2faaef81ccda?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&q=80&w=1200'
    ],
    features: ['12 Beaches', 'Ultra-Luxury', 'Private Pools', 'PADI Gold Palm Dive Centre'],
    transfers: [TransferType.SPEEDBOAT],
    mealPlans: [MealPlan.BED_BREAKFAST, MealPlan.HALF_BOARD],
    uvp: 'Unrivalled style and choice.'
  },
  {
    id: 'res-villa-nautica',
    ...
    priceRange: '$$$',
    rating: 5,
    shortDescription: 'A nautical-themed paradise just a short boat ride from Male.',
    description: 'Villa Nautica, formerly Paradise Island Resort, offers a vibrant nautical theme and world-class amenities. Located in North Male Atoll, it is accessible via a short speedboat ride and features a wide range of water sports and dining options.',
    images: [
      'https://images.unsplash.com/photo-1590523277543-a94d2e4eb00b?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1510011564758-29df30730163?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1502602898657-3e917247a183?auto=format&fit=crop&q=80&w=1200'
    ],
    features: ['Nautical Theme', 'Water Sports', 'Short Transfer', 'Vibrant Atmosphere'],
    transfers: [TransferType.SPEEDBOAT],
    mealPlans: [MealPlan.ALL_INCLUSIVE, MealPlan.HALF_BOARD],
    uvp: 'A nautical paradise.'
  },
  {
    id: 'res-olhuveli',
    ...
    priceRange: '$$$',
    rating: 4,
    shortDescription: 'A sprawling resort across three islands with something for everyone.',
    description: 'Sun Siyam Olhuveli spans three islands and offers a vast array of activities, from world-class diving to family-friendly fun. With multiple pools, restaurants, and bars, it is a perfect destination for all types of travelers.',
    images: [
      'https://images.unsplash.com/photo-1516815231560-8581bb6309f2?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1540206351-d6465b3ac5c1?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&q=80&w=1200'
    ],
    features: ['Three Islands', 'Water Sports', 'Family Friendly', 'Multiple Pools'],
    transfers: [TransferType.SPEEDBOAT],
    mealPlans: [MealPlan.ALL_INCLUSIVE, MealPlan.FULL_BOARD],
    uvp: 'Something for everyone.'
  },
  {
    id: 'res-joali',
    name: 'JOALI Maldives',
    ...
    priceRange: '$$$$$',
    rating: 5,
    shortDescription: 'An immersive art resort with sustainable luxury at its heart.',
    description: 'JOALI Maldives is the first immersive art resort in the Maldives. Located in Raa Atoll, it features sustainable luxury and exquisite design, with art installations scattered throughout the island.',
    images: [
      'https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1540206351-d6465b3ac5c1?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&q=80&w=1200'
    ],
    features: ['Art Resort', 'Sustainable Luxury', 'Exquisite Design', 'Raa Atoll'],
    transfers: [TransferType.SEAPLANE],
    mealPlans: [MealPlan.BED_BREAKFAST, MealPlan.HALF_BOARD],
    uvp: 'An immersive art experience.'
  },
  {
    id: 'res-nautilus',
    ...
    priceRange: '$$$$$',
    rating: 5,
    shortDescription: 'A highly personalized private island experience in Baa Atoll.',
    description: 'The Nautilus Maldives is a highly personalized private island experience. With only 26 beach and ocean houses, it offers ultimate privacy and freedom, with no fixed schedules and bespoke experiences.',
    images: [
      'https://images.unsplash.com/photo-1514282401047-d79a71a590e8?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1467377229449-49366afbb762?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&q=80&w=1200'
    ],
    features: ['Private Island', 'Bespoke Experiences', 'No Schedules', 'Baa Atoll'],
    transfers: [TransferType.SEAPLANE],
    mealPlans: [MealPlan.BED_BREAKFAST, MealPlan.HALF_BOARD],
    uvp: 'Ultimate freedom and privacy.'
  },
  {
    id: 'res-nh-collection',
    name: 'NH Collection Maldives Reethi Resort',
    slug: 'nh-collection-maldives-reethi-resort',
    type: AccommodationType.RESORT,
    atoll: 'Baa Atoll',
    priceRange: '$$$',
    rating: 4,
    shortDescription: 'A natural beauty in the heart of the Baa Atoll UNESCO Biosphere.',
    description: 'NH Collection Maldives Reethi Resort is located on a tiny island in Baa Atoll. It is a natural beauty, surrounded by a vibrant house reef and crystal-clear waters, offering a true Maldivian experience.',
    images: [
      'https://images.unsplash.com/photo-1502602898657-3e917247a183?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1439066615861-d1af74d74000?auto=format&fit=crop&q=80&w=1200',
      'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&q=80&w=1200'
    ],
    features: ['UNESCO Biosphere', 'Natural Beauty', 'House Reef', 'Baa Atoll'],
    transfers: [TransferType.SEAPLANE, TransferType.DOMESTIC_FLIGHT],
    mealPlans: [MealPlan.ALL_INCLUSIVE, MealPlan.HALF_BOARD],
    uvp: 'Natural Maldivian beauty.'
  }
];
